...
import (
	"context"
	dpfm_api_input_reader "data-platform-api-production-order-conf-deletes-rmq-kube/DPFM_API_Input_Reader"
	dpfm_api_output_formatter "data-platform-api-production-order-conf-deletes-rmq-kube/DPFM_API_Output_Formatter"
	"data-platform-api-production-order-conf-deletes-rmq-kube/config"
...
func (c *DPFMAPICaller) headerDelete(
	...
	header.ProductionOrder = input.Header.ProductionOrder
	header.ProductionOrderItem = input.Header.ProductionOrderItem
